...
export const DB_RUT_KINH_NGHIEM = [
...
// ── CÁC THÔNG BÁO RÚT KINH NGHIỆM BỔ SUNG ────────────────────────
  ...
  // ── VKSND TP. CẦN THƠ – BỔ SUNG 2025 ───────────────────────
  {
    id: "rkn-040",
    soThongBao: "04/2025/TB-VKSCT",
    tieuDe: "Rút kinh nghiệm về kiểm sát xét xử vắng mặt bị cáo theo Thông tư liên tịch 05/2025",
    ngayBanHanh: "10/07/2025",
    linhVuc: "Hình sự",
    capBanHanh: "VKSND TP. Cần Thơ",
    noiDungViPham: "Một số vụ án xét xử vắng mặt chưa bảo đảm thông báo đầy đủ cho người bào chữa và người đại diện hợp pháp của bị cáo; hồ sơ thiếu biên bản họp thống nhất giữa CQĐT và VKS trước khi kết thúc điều tra.",
    baiHoc: "Trước khi truy tố hoặc đề nghị xét xử vắng mặt, phải kiểm tra đủ điều kiện theo TTLT 05/2025: chứng cứ đầy đủ, quyền bào chữa được bảo đảm, có biên bản họp thống nhất.",
    bienPhap: "Tổ chức tập huấn TTLT 05/2025; lập checklist kiểm tra hồ sơ xét xử vắng mặt trước khi ban hành cáo trạng.",
    file: ""
  },
  {
    id: "rkn-041",
    soThongBao: "05/2025/TB-VKSCT",
    tieuDe: "Rút kinh nghiệm về kiểm sát án dân sự liên quan đất đai theo Luật Đất đai 2024",
    ngayBanHanh: "15/08/2025",
    linhVuc: "Dân sự",
    capBanHanh: "VKSND TP. Cần Thơ",
    noiDungViPham: "Kiểm sát viên chưa yêu cầu Tòa án thu thập hồ sơ đăng ký biến động theo Luật Đất đai 2024; bản án xác định ranh giới đất không khớp với bản đồ địa chính.",
    baiHoc: "Trong án tranh chấp đất đai, phải đối chiếu GCNQSDĐ, bản đồ địa chính và hồ sơ đăng ký biến động; yêu cầu thẩm định tại chỗ khi có mâu thuẫn về ranh giới.",
    bienPhap: "Phối hợp Sở Nông nghiệp và Môi trường lấy ý kiến chuyên môn; áp dụng quy trình DS-DD-01 trong nghiệp vụ kiểm sát.",
    file: ""
  },
  {
    id: "rkn-042",
    soThongBao: "06/2025/TB-VKSCT",
    tieuDe: "Rút kinh nghiệm về xử lý trường hợp Tòa án tuyên bị cáo không phạm tội",
    ngayBanHanh: "20/12/2025",
    linhVuc: "Hình sự",
    capBanHanh: "VKSND TP. Cần Thơ",
    noiDungViPham: "Sau khi Tòa án tuyên không phạm tội, VKS chậm báo cáo VKS cấp trên; chưa làm rõ trách nhiệm kiểm sát viên và chưa tiếp nhận yêu cầu bồi thường của bị can.",
    baiHoc: "Áp dụng Hướng dẫn 45/HD-VKSTC: báo cáo trong 24 giờ, phân tích căn cứ bản án, xem xét kháng nghị hoặc kiểm điểm; chủ động hướng dẫn bồi thường theo Luật Trách nhiệm bồi thường của Nhà nước.",
    bienPhap: "Ban hành quy trình nội bộ HS-QL-01; phân công cán bộ theo dõi, tổng hợp báo cáo định kỳ.",
    file: ""
  },
  {
    id: "rkn-043",
    soThongBao: "07/2025/TB-VKSCT",
    tieuDe: "Rút kinh nghiệm về chất lượng kháng nghị phúc thẩm vụ án ma túy",
    ngayBanHanh: "05/03/2025",
    linhVuc: "Hình sự",
    capBanHanh: "VKSND TP. Cần Thơ",
    noiDungViPham: "Quyết định kháng nghị phúc thẩm vụ án ma túy chưa căn cứ vào NQ 03/2025/NQ-HĐTP khi xác định tội danh và hình phạt; thiếu phân tích khối lượng, loại ma túy theo quy định mới.",
    baiHoc: "Khi kháng nghị án ma túy phải đối chiếu NQ 03/2025/NQ-HĐTP về ngưỡng trách nhiệm hình sự, tình tiết tăng nặng và xử lý vật chứng.",
    bienPhap: "Tổ chức nghiên cứu NQ 03/2025; xây dựng mẫu kháng nghị phúc thẩm chuyên đề ma túy.",
    file: ""
  }
];
