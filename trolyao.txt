...
Đồng chí cần hỗ trợ vấn đề gì hôm nay?</div>
  ...
  <script>
    ...
    function sendMessage() {
      ...
      // 3. Giả lập gọi API AI (Có thể thay thế bằng fetch gọi API thật sau này)
      setTimeout(() => {
        removeTypingIndicator(typingId);
        
        // Đoạn phản hồi mẫu mô phỏng nghiệp vụ kiểm sát
        const aiResponse = `🤖 Dựa trên dữ liệu hệ thống LEXVIET và đối chiếu quy định hiện hành, tôi xin phân tích tình huống đồng chí vừa nêu như sau:

1. Cơ sở pháp lý áp dụng:
- Bộ luật Hình sự năm 2015 (sửa đổi, bổ sung 2017).
- Các văn bản hướng dẫn thi hành liên quan trực tiếp đến lĩnh vực này.

2. Đánh giá hồ sơ:
- Hành vi có dấu hiệu thỏa mãn các yếu tố cấu thành cơ bản của tội phạm.
- Tuy nhiên, cần rà soát lại lời khai của các bên liên quan và đối chiếu cẩn thận với vật chứng/dấu vết hiện trường nhằm đảm bảo nguyên tắc suy đoán vô tội và tuân thủ nghiêm ngặt Bộ luật Tố tụng Hình sự.

3. Đề xuất hướng xử lý:
- Yêu cầu Cơ quan điều tra bổ sung các chứng cứ vật chất còn thiếu.
- Củng cố căn cứ pháp lý trước khi ban hành Cáo trạng.

Đồng chí có muốn tôi xuất báo cáo chi tiết cho tình huống này ra file Word không?`;

        appendMessage('ai', aiResponse);
        sendBtn.disabled = false;
        userInput.focus();
      }, 2000); // Đợi 2 giây giả lập thời gian AI suy nghĩ
    }
